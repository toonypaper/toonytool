...
.visualize-labels-y li .label{ font-size:10px; font-family:tahoma; }
.visualize-labels-x li .label{ width:30px; font-weight:bold; font-size:10px; font-family:tahoma; }
</style>
