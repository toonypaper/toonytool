	...
	*/
	$db_toony_board_config = "
		create table toony_module_board_config(
			...
			ico_file char(3) default 'Y|Y',
			ico_mobile char(3) default 'Y|Y',
			ico_secret char(3) default 'Y|Y',
			ico_secret_def char(1) default 'N',
			ico_new char(3) default 'Y|Y',
			ico_new_def int(11) default '4320',
			ico_hot char(3) default 'N|N',
			ico_hot_def varchar(50) default '10|OR|50',
			regdate datetime,
